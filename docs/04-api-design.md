...
>
> **وضعیت پیاده‌سازی فعلی:** کاتالوگ عمومی، احراز هویت Sanctum، داشبورد، تسویه دوره، سبد، علاقه‌مندی و پلیر/یادداشت/نشانک در `routes/api.php` فعال است. بقیهٔ فهرست زیر نقشهٔ توسعه است.
