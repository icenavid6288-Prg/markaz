...
import { ArrowLeft, KeyRound, MessageSquareText, ShieldCheck, Smartphone } from 'lucide-react';
    ...
    return (
        <GuestLayout>
            ...
            <p className="mt-2 text-sm leading-7 text-navy/55">
                شماره موبایل خود را وارد کنید؛ یک کد تأیید شش‌رقمی برایتان پیامک می‌شود.
            </p>
            ...
            <form onSubmit={submit} className="mt-7 flex flex-col gap-5">
                ...
                >
                    ...
                    {processing ? 'در حال ارسال کد...' : 'ارسال کد تأیید'}
                </button>
                ...
                <div className="flex items-center justify-center gap-2 text-xs font-bold text-navy/45">
                    ...
                    کد تأیید فقط به شماره موبایل شما پیامک می‌شود.
                </div>
            </form>
