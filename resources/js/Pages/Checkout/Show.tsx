...
import { ArrowRight, CheckCircle2, CreditCard, LockKeyhole, ShoppingBag } from 'lucide-react';
...
export default function CheckoutShow({ order, payment = { enabled: false, gateway: 'local' } }: { order: CheckoutOrder; payment?: { enabled: boolean; gateway: string } }) {
