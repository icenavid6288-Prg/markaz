...
import { ArrowRight, Award, CheckCircle2, ChevronLeft, CirclePlay, ClipboardList, Clock3, FileText, ListChecks, LockKeyhole, Paperclip, Play, RotateCcw, Send, Sparkles, XCircle } from 'lucide-react';
...
interface PlayerProps { course: { id: number; title: string; slug: string; thumbnail?: string | null }; enrollment: { progress_percent: number; certificate?: { number: string; url: string } | null }; lessons: Module[]; currentLesson: Lesson }

export default function Player() {
    const { course, enrollment, lessons, currentLesson } = usePage<PageProps & PlayerProps>().props;
