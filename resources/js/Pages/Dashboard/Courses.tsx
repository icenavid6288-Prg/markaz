...
import { ArrowLeft, BookOpen, CheckCircle2, Clock3, MapPin, Sparkles } from 'lucide-react';
import type { ReactNode } from 'react';
import UserDashboardLayout from '@/Layouts/UserDashboardLayout';
import { formatDuration, formatNumber } from '@/lib/format';
import type { PageProps } from '@/types';

interface Course { id: number; title: string; slug: string; thumbnail?: string | null; duration_minutes: number; progress_percent: number; status: string; enrolled_at?: string | null; is_in_person?: boolean; location?: string | null; }
