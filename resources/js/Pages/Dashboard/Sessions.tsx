...
interface Session { id: number; scheduled_at?: string | null; duration_minutes: number; status: string; meeting_link?: string | null; coach?: string | null; can_cancel?: boolean; }
