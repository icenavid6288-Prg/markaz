...
/**
 * Collapsible Persian usage guide shown at the top of every Instagram panel page.
 * Pass `steps` (numbered how-to) and optionally `hints` (short tips, cautions).
 */
export function InstagramGuide({ title = 'راهنمای استفاده از این صفحه', steps, hints = [], defaultOpen = false }: {
    title?: string;
    steps: GuideStep[];
    hints?: string[];
    defaultOpen?: boolean;
