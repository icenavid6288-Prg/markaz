        ...
        return [
            'home' => [
                ...
                'fields' => [
                    ...
                    'problem_image' => ['label' => 'تصویر بخش دغدغه‌ها', 'type' => 'image', 'value' => '', 'icon' => 'Image'],
                    'problem_video' => ['label' => 'ویدیوی بخش دغدغه‌ها (یوتیوب، ویمیو یا MP4)', 'type' => 'video', 'value' => '', 'icon' => 'Video'],
            ...
            'about' => [
                ...
                'fields' => [
                    ...
                    'intro_image' => ['label' => 'تصویر بخش معرفی', 'type' => 'image', 'value' => '', 'icon' => 'Image'],
                    'intro_video' => ['label' => 'ویدیوی بخش معرفی (یوتیوب، ویمیو یا MP4)', 'type' => 'video', 'value' => '', 'icon' => 'Video'],
                    'mission_image' => ['label' => 'تصویر بخش مأموریت و ارزش‌ها', 'type' => 'image', 'value' => '', 'icon' => 'Image'],
                    'mission_video' => ['label' => 'ویدیوی بخش مأموریت و ارزش‌ها (یوتیوب، ویمیو یا MP4)', 'type' => 'video', 'value' => '', 'icon' => 'Video'],
                    'team_image' => ['label' => 'تصویر بخش تیم ما', 'type' => 'image', 'value' => '', 'icon' => 'Image'],
                    'team_video' => ['label' => 'ویدیوی بخش تیم ما (یوتیوب، ویمیو یا MP4)', 'type' => 'video', 'value' => '', 'icon' => 'Video'],
                    'testimonials_image' => ['label' => 'تصویر بخش اعتماد خانواده‌ها', 'type' => 'image', 'value' => '', 'icon' => 'Image'],
                    'testimonials_video' => ['label' => 'ویدیوی بخش اعتماد خانواده‌ها (یوتیوب، ویمیو یا MP4)', 'type' => 'video', 'value' => '', 'icon' => 'Video'],
                ],
            ],
            'contact' => [
