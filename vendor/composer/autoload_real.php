...
class ComposerAutoloaderInitMarkaz
{
    ...
    public static function getLoader()
    {
        ...
        spl_autoload_register(array('ComposerAutoloaderInitMarkaz', 'loadClassLoader'), true, true);
        self::$loader = $loader = new \\Composer\\Autoload\\ClassLoader(__DIR__);
        spl_autoload_unregister(array('ComposerAutoloaderInitMarkaz', 'loadClassLoader'));
